...
const AiAgentWidget: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Show manual trigger after 15 seconds if widget hasn't loaded
    ...
    const timer = setTimeout(() => {
      loadWidget()
    }, 20000) // Increased to 20 seconds for maximum performance
    ...
    const handleScroll = () => {
      scrollCount++
      if (scrollCount > 10) { // Increased scroll threshold
        loadWidget()
