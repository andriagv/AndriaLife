export const translations = {
  en: {
    ...
    designStory: "I am passionate about design and have worked on a variety of creative projects, from UI/UX to branding. My goal is to create visually appealing and user-friendly solutions that make a difference.",
    sportsStory: "I have been active since childhood and was passionate about various sports. Football particularly caught my attention at age 5, when I was given a football as a birthday gift — since then, this sport became a true passion for me. I took my first step on the professional path in second grade, when I started training with the local village team. Unfortunately, a tragic incident occurred — my coach passed away on the day of the second training session. After a few months' break, I decided to try my luck again. My father took me to one of the teams in a nearby city, but unfortunately for me (or perhaps fortunately), there was no age group for my age there, and my physical attributes were still unsuitable for playing with players two years older at that time. Finally, after all this, at my mother's insistence, I followed mathematics — thus ended my aspiration toward a professional football career.\n\n2019–2020 📍 Komarovi Volleyball Team\n2020–2022 ⚽️ Komarovi Football Team\n2022–2023 🏐 KIU Volleyball Team\n2024–2025 ⚽️ KIU Football Team",
  ...
  ka: {
    ...
    designStory: "მე ვარ გატაცებული დიზაინით და მიმუშავია სხვადასხვა კრეატიულ პროექტზე — UI/UX-დან ბრენდინგამდე. ჩემი მიზანია შევქმნა ვიზუალურად მიმზიდველი და მომხმარებელზე ორიენტირებული გადაწყვეტილებები, რომლებიც მნიშვნელობას მატებს გარემოს.",
    sportsStory: "ბავშვობიდან აქტიური ვიყავი და სხვადასხვა სპორტით ვიყავი გატაცებული. განსაკუთრებით დამაინტერესა ფეხბურთმა, როცა 5 წლის ასაკში დაბადების დღეზე ბურთი მაჩუქეს — მას შემდეგ ეს სპორტი ჩემთვის ნამდვილ გატაცებად იქცა. პროფესიულ გზაზე პირველი ნაბიჯი მეორე კლასში გადავდგი, როცა ადგილობრივ სოფლის გუნდში ვვარჯიშობდი. სამწუხაროდ, ტრაგიკული შემთხვევა მოხდა — მწვრთნელი მეორე ვარჯიშის დღეს გარდაიცვალა. რამდენიმე თვიანი პაუზის შემდეგ, კიდევ ერთხელ ვცადე ბედი. მამამ მიმიყვანა ახლომდებარე ქალაქის ერთ-ერთ გუნდში, მაგრამ სამწუხაროდ (ან საბედნიეროდ), იქ ჩემი ასაკის ჯგუფი არ იყო და ჩემი ფიზიკური მონაცემები მაშინ ჯერ კიდევ შეუფერებელი იყო ორი წლით უფროსებთან სათამაშოდ. საბოლოოდ, ამ ყველაფრის შემდეგ, დედაჩემის დაჟინებული თხოვნით, მათემატიკას მივყევი — ასე დასრულდა ჩემი პროფესიული ფეხბურთის კარიერისკენ სწრაფვა.\n\n2019–2020 📍 კომაროვის ფრენბურთის გუნდი\n2020–2022 ⚽️ კომაროვის ფეხბურთის გუნდი\n2022–2023 🏐 KIU ფრენბურთის გუნდი\n2024–2025 ⚽️ KIU ფეხბურთის გუნდი",
